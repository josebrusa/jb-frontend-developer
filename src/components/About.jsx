    ...
    <div id="resume" className="bg-white/10">
      <div className="max-w-[1040px]  m-auto pl-20 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-2 py-10 items-center">
          <p className="text-start py-2 text-gray-200">
            ...
            plataformas líderes como Google, Udemy y Platzi. <br /> Como
            frontend developer, mi objetivo es crear experiencias de usuario
            atractivas y funcionales a través de interfaces web y móviles
            intuitivas. Siempre busco mejorar mis habilidades técnicas y
            mantenerme actualizado con las últimas tendencias y mejores
            prácticas del desarrollo frontend. Estoy emocionado por la
            oportunidad de aplicar mi pasión y conocimientos en mi primer
            trabajo en IT.
          </p>
          <div className=" absolute right-[16rem] w-[350px] h-[350px] rounded-md shadow-[30px_-23px_28px_-2px_rgba(41,243,195,0.55)]">
            <img
