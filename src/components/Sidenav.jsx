      ...
      <div className="md:block hidden fixed top-[25%] z-10">
        <div className="flex flex-col">
          <a
            href="#header"
            aria-label="header"
            className="rounded-full border-1 border-solid border-[#4A4A4A] opacity-80 shadow-md bg-[#343639] shadow-[#343639]  m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200"
          >
            <AiOutlineHome size={20} color="#fff" />
          </a>
          <a
